...
VAR_BLOCK_RE = re.compile(r"var\s+(?P<name>ValidatorsAddA|ValidatorsAddB|after410LegacyTargetsA|after410LegacyTargetsB)\s*=\s*(?:map\[string\]string|(?:\[\]string))\s*\{(?P<body>.*?)\n\}", re.S)
