#!/usr/bin/env python3
"""Build finalized-height series from BSC experiment logs."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Parse node0/node10 BSC logs and output finalized-height series "
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("finalized_heights.csv"),
